...
import Modelo.ModeloRenovarCupo;
...
public class ControladorRenovarCupo implements ActionListener, KeyListener, ItemListener {
    
    private RenovarCupo obj1;
    private ModeloRenovarCupo obj2 = new ModeloRenovarCupo();
    ...
    public ControladorRenovarCupo(RenovarCupo obj1) {
        this.obj1 = obj1;
        this.txt1 = obj1.txt1;
        this.txt2 = obj1.txt2;
        this.txt3 = obj1.txt3;
    ...
    private void posicinarFrame(JDesktopPane escritorio, JInternalFrame ventana) {
        ...
        GestionarClientes.jPanel1.setBackground(fondo);
        GestionarClientes.jPanel2.setBackground(fondo);
    ...
    private int insertarDeuda() {
        ...
        rss = obj2.consultaCuotaDeudaVieja(DatosGestionarClientes.getId());
        try {
            while (rss.next()){
                monpre = monpre + rss.getLong("monto_actual");
            }                
        } catch(SQLException error){
            System.out.println("Erroy de MySql"+error);
        } catch(NumberFormatException error){
        ...
        int respuesta = obj2.registrarDueda(monpre, monint, cancou, fecini, idmod, idestcue, idcli);
    ...
    private int insertarMovimiento() {
        ...
        String iddeuvie = null;
        int cuotdeuvie = 0;
        long mondeuvie = 0;
        rss = obj2.consultaIdDeudaVieja(ide);
        try {
            while (rss.next()){
                iddeuvie = rss.getString("d.id_deuda");
                cuotdeuvie = rss.getInt("md.cuota_actual");
                mondeuvie = rss.getLong("md.monto_actual");
            }                
        } catch(SQLException error){
            System.out.println("Erroy de MySql"+error);
        } catch(NumberFormatException error){
        ...
        monact = monact+mondeuvie;
        
        int resultado1 = obj2.registrarMovimientoRenovar(cuotdeuvie, 0, mondeuvie, 0, null, "4", iddeuvie);
        int resultado2 = obj2.registrarMovimientoRenovar(cuovie, cuoact, monvie, monact, propag, idmov, iddeu);
        int resultado3 = obj2.actualizarDeudaVieja(DatosGestionarClientes.getId());
            ...
            posicinarFrame(Principal.jDesktopPane1, obj2);
                ...
                if (ban==true) {
                    ...
                    if (val==true) {
                        ...
                        alerta("La Renovación de Cupo se Realizo con Exito!");
