...
DROP  TRIGGER IF EXISTS actualizarMovimiento;

CREATE TRIGGER actualizarMovimiento AFTER UPDATE ON movimientos_deudas
FOR EACH ROW
...
>>>>>>> 06dc7ca0df246d8498757884f91aff99e49c0881
DELIMITER ;